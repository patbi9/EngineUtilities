...
public:
 ...
 CVector3 
  operator+(const CVector3& otro) const {
 ...
 CVector3 
  cross(const CVector3& otro) const {
  return CVector3(
  y * otro.z - z * otro.y,
  z * otro.x - x * otro.z,
  x * otro.y - y * otro.x
